...
<head>
    ...
    <title>Detalles del Jugador - Demo ASIX</title>
...
<div class="container mt-5">
    ...
    <!-- Card con los detalles del jugador -->
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <p><strong>Año de Nacimiento:</strong> <?= $player->birthYear; ?></p>
        </div>
    </div>

    <!-- Botón para volver -->
    <a href="/players" class="btn btn-back">Volver a la lista</a>
</div>
